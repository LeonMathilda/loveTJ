...
@interface UIImage ()
- (CGImageRef)newBorderMask:(NSUInteger)borderSize size:(CGSize)size color:(UIColor *)color;
@end
...
- (UIImage *)transparentBorderImage:(NSUInteger)borderSize {
    ...
    CGImageRef maskImageRef = [self newBorderMask:borderSize size:newRect.size color:[UIColor blackColor]];
...
- (UIImage *)transparentBorderImage:(NSUInteger)borderSize color:(UIColor *)color{
    ...
    // Create a mask to make the border transparent, and combine it with the image
    CGImageRef maskImageRef = [self newBorderMask:borderSize size:newRect.size color:color];
    CGImageRef transparentBorderImageRef = CGImageCreateWithMask(borderImageRef, maskImageRef);
    UIImage *transparentBorderImage = [UIImage imageWithCGImage:transparentBorderImageRef];
...
- (CGImageRef)newBorderMask:(NSUInteger)borderSize size:(CGSize)size color:(UIColor *)color {
    ...
    CGContextSetFillColorWithColor(maskContext, color.CGColor);
