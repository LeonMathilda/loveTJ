...
+ (void) dateFromNetWorkonCompletion:(void (^)(NSDate *date))dateBlock
{
    [NSURLConnection sendAsynchronousRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:@"http://www.baidu.com"]]
