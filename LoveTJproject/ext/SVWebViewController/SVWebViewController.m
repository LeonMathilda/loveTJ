...
{
    if ([request.URL.absoluteString rangeOfString:@"asyn_payment_result"].location != NSNotFound) {
        [[NSNotificationCenter defaultCenter] postNotificationName:kNotificationDidPayOrder object:nil];
    }
